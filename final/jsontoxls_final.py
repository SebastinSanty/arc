...
sheet.write(0, 3, 'CDC Left')
sheet.write(0, 4, 'DEL1 Left')
sheet.write(0, 5, 'DEL2 Left')
sheet.write(0, 6, 'HUM Left')
sheet.write(0, 7, 'OPEN Left')
...
workbook.save(os.path.join('result',"final.xls"))